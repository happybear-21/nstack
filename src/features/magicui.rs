...
pub async fn add_magicui() -> Result<()> {
    ...
    pb.set_message("Installing magicui dependencies...");
    ...
    Command::new(cmd)
        ...
        .status()
        .context("Failed to install magicui dependencies")?;
...
@layer base {
  * {
  ...
  body {
    ...
    pb.finish_with_message("magicui installed successfully!");
